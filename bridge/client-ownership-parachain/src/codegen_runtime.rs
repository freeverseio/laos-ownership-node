                        ...
                        pub mod pallet {
                                ...
                                pub enum Call {
                                        ...
                                        receive_messages_proof {
                                                relayer_id_at_bridged_chain: runtime_types::fp_account::AccountId20,
                                                proof: ::std::boxed::Box<
                                                        ::bp_messages::target_chain::FromBridgedChainMessagesProof<
                                                                runtime_types::bp_evochain::evo_hash::EvoHash,
                                                        >,
                                                >,
                                ...
                                #[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq)]
                                pub enum Error {
                                        # [codec (index = 0)] NotOperatingNormally , # [codec (index = 1)] LanesManager (runtime_types :: pallet_bridge_messages :: lanes_manager :: LanesManagerError ,) , # [codec (index = 2)] MessageRejectedByPallet (runtime_types :: bp_messages :: VerificationError ,) , # [codec (index = 3)] TooManyMessagesInTheProof , # [codec (index = 4)] InvalidMessagesProof , # [codec (index = 5)] InvalidMessagesDeliveryProof , # [codec (index = 6)] InvalidUnrewardedRelayersState , # [codec (index = 7)] InsufficientDispatchWeight , # [codec (index = 8)] ReceivalConfirmation (runtime_types :: pallet_bridge_messages :: outbound_lane :: ReceivalConfirmationError ,) , # [codec (index = 9)] BridgeModule (runtime_types :: bp_runtime :: OwnedBridgeModuleError ,) , }
                                #[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq)]
                                pub enum Event {
