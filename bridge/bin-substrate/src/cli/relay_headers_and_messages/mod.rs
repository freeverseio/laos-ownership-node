...
declare_chain_cli_schema!(Evochain, evochain);
declare_chain_cli_schema!(OwnershipParachain, ownership_parachain);
...
// declare_relay_to_parachain_bridge_schema!(Evochain, OwnershipParachain, Rococo);
